### Table 2. Feature split ablation: classification performance with 95% bootstrap confidence intervals (CI) on the 2022 extreme flood test period.

| Feature Split | F1 [95% CI] | IoU [95% CI] | Precision [95% CI] | Recall [95% CI] | AUC [95% CI] |
| :--- | :---: | :---: | :---: | :---: | :---: |
