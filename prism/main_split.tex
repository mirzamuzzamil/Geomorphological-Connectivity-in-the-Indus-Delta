...
available.
The derived point-level spatial-temporal dataset compiled and used in this study will be made publicly available on Zenodo upon publication. In the interim, the dataset is available from the corresponding author upon request.
