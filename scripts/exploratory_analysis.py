...
def main():
    parser = argparse.ArgumentParser(description="Exploratory Hydrological Analysis for Indus Delta")
    parser.add_argument("--start_year", type=int, default=2022, help="Start year of analysis series")
    parser.add_argument("--end_year", type=int, default=2024, help="End year of analysis series")
    ...
    print(f"\nRunning Exploratory Hydrological Analysis across Indus Delta Sample Points ({args.start_year}-{args.end_year})...")
    
    # Sample monthly intervals
    months = []
    ...
    for name, geom in points.items():
        ...
        try:
            ...
            print(f"  Failed to retrieve time series from GEE: {e}")
            print("  Please make sure you have GEE credentials and billing enabled.")
