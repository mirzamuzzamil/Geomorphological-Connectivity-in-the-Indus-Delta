...
def main():
    ...
    static_img = ee.Image.cat([dem, slope, dist_to_river, dist_to_coast, jrc_occ.rename("occurrence")])
    
    print("Sampling static terrain and occurrence features at points...")
